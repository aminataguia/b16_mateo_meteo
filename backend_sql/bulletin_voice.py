...
from fonctions import get_forecast_for_city, main
...
async def weather_bulletin(city: str):
    ...
    payload = {
        ...
        "text": f"fait moi un bulletin météo sous forme de phrase {main(city)}, noublie pas d'indiquer la température et de rappeler le nom de la ville et le jours de la prediction",
        "temperature": 0.2,
        "max_tokens": 250,
        "fallback_providers": ""
    }
